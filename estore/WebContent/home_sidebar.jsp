                                    ...
                                    <div class="feature_inner row m0">
                                        <div class="left_promotion">
                                            <div class="f_add_item">
                                                <div class="f_add_img"><img class="img-fluid" src="images/f-add-6.jpg" alt=""></div>
                                        ...
                                        <div class="right_promotion">
                                            <div class="f_add_item right_dir">
                                                <div class="f_add_img"><img class="img-fluid" src="images/f-add-7.jpg" alt=""></div>
                                                <div class="f_add_hover">
                                    ...
                                    <div class="home_l_product_slider owl-carousel">
                                        <div class="item woman shoes">
                                            <div class="l_product_item">
                                                <div class="l_p_img">
                                                    <img src="images/f-product-8.jpg" alt="">
                                            ...
                                            <div class="l_product_item woman bags">
                                                <div class="l_p_img">
                                                    <img src="images/f-product-11.jpg" alt="">
                                                    <h5 class="new">New</h5>
                                                </div>
                                                <div class="l_p_text">
                                                   <ul>
                                        ...
                                        <div class="item woman bags">
                                            <div class="l_product_item">
                                                <div class="l_p_img">
                                                    <img src="images/f-product-9.jpg" alt="">
                                                </div>
                                                <div class="l_p_text">
                                                   <ul>
                                                        <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                                            ...
                                            <div class="l_product_item">
                                                <div class="l_p_img">
                                                    <img src="images/f-product-12.jpg" alt="">
                                                </div>
                                                <div class="l_p_text">
                                                   <ul>
                                                        <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                                        ...
                                        <div class="item shoes bags">
                                            <div class="l_product_item">
                                                <div class="l_p_img">
                                                    <img src="images/f-product-10.jpg" alt="">
                                                    <h5 class="sale">Sale</h5>
                                                </div>
                                                <div class="l_p_text">
                                                   <ul>
                                            ...
                                            <div class="l_product_item">
                                                <div class="l_p_img">
                                                    <img src="images/f-product-13.jpg" alt="">
                                                    <h5 class="sale">Sale</h5>
                                                </div>
                                                <div class="l_p_text">
                                                   <ul>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="from_blog_item">
                                                <img class="img-fluid" src="images/f-blog-4.jpg" alt="">
                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="from_blog_item">
                                                <img class="img-fluid" src="images/f-blog-5.jpg" alt="">
                                                <div class="f_blog_text">
                                                    <h5>fashion</h5>
                                                    <p>Neque porro quisquam est qui dolorem ipsum</p>
                                                    <h6>21.09.2017</h6>
                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="from_blog_item">
                                                <img class="img-fluid" src="images/f-blog-6.jpg" alt="">
                                                <div class="f_blog_text">
                                                    <h5>fashion</h5>
                                                    <p>Neque porro quisquam est qui dolorem ipsum</p>
                                                    <h6>21.09.2017</h6>
                        ...
                        <div class="col-lg-3 float-md-right">
                            <div class="left_sidebar_area">
                                ...
                                <aside class="l_widget l_supper_widget">
                                    <img class="img-fluid" src="images/supper-add-1.jpg" alt="">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="world_service_item">
                                    <h4><img src="images/world-icon-1.png" alt="">Worldwide Service</h4>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="world_service_item">
                                    <h4><img src="images/world-icon-2.png" alt="">247 Help Center</h4>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="world_service_item">
                                    <h4><img src="images/world-icon-3.png" alt="">Safe Payment</h4>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="world_service_item">
                                    <h4><img src="images/world-icon-4.png" alt="">Quick Delivary</h4>
                                </div>
                            </div>
                        </div>
                    </div>
