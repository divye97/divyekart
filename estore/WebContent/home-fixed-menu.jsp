        ...
        <div class="home_left_main_area">
                        ...
                        <ul class="nav flex-column">
                            <li class="dropdown side_menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="home-fullwidth.html">Home Full Width</a></li>
                                    <li class="nav-item"><a class="nav-link" href="home-parallax.html">Home Parallax</a></li>
                                    <li class="nav-item"><a class="nav-link" href="home_sidebar.jsp">Home Boxed</a></li>
                            ...
                            <li class="dropdown side_menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="grid-right-sidebar.jsp">Categories Right Sidebar</a></li>
            ...
            <div class="right_body">
                <div class="best_summer_banner">
                    <img class="img-fluid" src="images/summer-banner.jpg" alt="">
                    ...
                    <div class="l_product_slider owl-carousel">
                        <div class="item">
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="images/l-product-9.jpg" alt="">
                            ...
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="images/l-product-10.jpg" alt="">
                                </div>
                                <div class="l_p_text">
                                   <ul>
                                        <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                            ...
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="images/l-product-11.jpg" alt="">
                                </div>
                                <div class="l_p_text">
                                   <ul>
                                        <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                        ...
                        <div class="item">
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="images/l-product-12.jpg" alt="">
                                    <h5 class="new">New</h5>
                                </div>
                                <div class="l_p_text">
                                   <ul>
                            ...
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="images/l-product-13.jpg" alt="">
                                    <h5 class="sale">Sale</h5>
                                </div>
                                <div class="l_p_text">
                                   <ul>
                            ...
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="images/l-product-14.jpg" alt="">
                                </div>
                                <div class="l_p_text">
                                   <ul>
                                        <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                        ...
                        <div class="item">
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="images/l-product-15.jpg" alt="">
                                </div>
                                <div class="l_p_text">
                                   <ul>
                                        <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                            ...
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="images/l-product-16.jpg" alt="">
                                    <h5 class="sale">Sale</h5>
                                </div>
                                <div class="l_p_text">
                                   <ul>
                            ...
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="images/l-product-17.jpg" alt="">
                                    <h5 class="sale">Sale</h5>
                                </div>
                                <div class="l_p_text">
                                   <ul>
                        ...
                        <div class="item">
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="images/l-product-18.jpg" alt="">
                                    <h5 class="sale">Sale</h5>
                                </div>
                                <div class="l_p_text">
                                   <ul>
                            ...
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="images/l-product-19.jpg" alt="">
                                </div>
                                <div class="l_p_text">
                                   <ul>
                                        <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                            ...
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="images/l-product-20.jpg" alt="">
                                </div>
                                <div class="l_p_text">
                                   <ul>
                                        <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                    ...
                    <div class="row m0">
                        <div class="col-lg-6">
                            <div class="f_add_item white_add">
                                <div class="f_add_img"><img class="img-fluid" src="images/f-add-8.jpg" alt=""></div>
                        ...
                        <div class="col-lg-6">
                            <div class="f_add_item white_add">
                                <div class="f_add_img"><img class="img-fluid" src="images/f-add-9.jpg" alt=""></div>
                                <div class="f_add_hover">
                                    <h4>Best Summer <br>Collection</h4>
                                    <a class="add_btn" href="#">Shop Now <i class="arrow_right"></i></a>
                                </div>
