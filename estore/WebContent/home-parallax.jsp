    ...
    <body class="home_parallax">
        ...
        <section class="full_page_area">
            <section id="fullpage" class="full_page_inner">
                <div class="section soda_can active" style="background: url(images/parallax-1.jpg); background-size: cover; background-repeat: no-repeat; background-position: center center;">
                ...
                <div class="section" style="background: url(images/parallax-2.jpg); background-size: cover; background-repeat: no-repeat; background-position: center center;">
                    <div class="paper_inner">
                ...
                <div class="section" style="background: url(images/parallax-3.jpg); background-size: cover; background-repeat: no-repeat; background-position: center center;">
                ...
                <div class="section" style="background: url(images/parallax-4.jpg); background-size: cover; background-repeat: no-repeat; background-position: center center;">
                    <div class="paper_inner">
                        <div class="parallax_style_one">
